...
def predict(min_temp, max_temp, rainfall, evaporation, sunshine, wind_gust_speed, 
    ...
    df_input = pd.DataFrame(input_data, columns=['min_temp', 'max_temp', 'rainfall', 
                                                  'evaporation', 'sunshine', 'wind_gust_speed',
...
if st.button("Прогнозувати дощ"):
    ...
    result = predict(min_temp, max_temp, rainfall, evaporation, sunshine, wind_gust_speed,
